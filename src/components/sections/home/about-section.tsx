...
export function AboutSection() {
  ...
  return (
    <section ref={sectionRef} id="about" className="relative box-border bg-white px-4 py-20 text-black sm:px-6 sm:py-24 lg:px-8 lg:py-32 mt-50" aria-label="About section">
      <div className="container relative mx-auto grid grid-cols-1 grid-rows-1 gap-x-6 gap-y-14 md:grid-cols-5 md:grid-rows-4">
        <TextReveal
        ...
        <div className="relative h-[clamp(1.85rem,3.7vmin,2.75rem)] md:hidden">
          <motion.div
            className="absolute top-0 z-10 inline-flex items-center gap-3 text-[clamp(1.85rem,3.7vmin,2.75rem)] leading-[1] tracking-[-0.045em] text-gradient-black-gray [&_*]:leading-[1]"
            style={{ left: markerLeft, x: markerX }}
          >
        ...
        <motion.div
          className="absolute z-10 hidden items-center gap-3 text-[clamp(1.85rem,3.7vmin,2.75rem)] leading-[1] tracking-[-0.045em] text-gradient-black-gray md:inline-flex md:text-[clamp(1.85rem,3.7vmin,3.7rem)] lg:text-[clamp(1.85rem,4.6vmin,3.7rem)] xl:text-[clamp(1.85rem,5.4vmin,3.7rem)] [&_*]:leading-[1]"
