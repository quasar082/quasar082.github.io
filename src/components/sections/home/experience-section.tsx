...
export function ExperienceSection({ experiences }: ExperienceSectionProps) {
  ...
  return (
    <section ref={sectionRef} id="experience" className="relative z-0 box-border min-h-screen bg-white pt-100 pb-[calc(25rem+100vh)] text-black" aria-label="Experience section">
