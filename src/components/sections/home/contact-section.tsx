...
export function ContactSection({ contactSocials }: ContactSectionProps) {
  return (
    <section id="contact" className="box-border flex min-h-dvh flex-col overflow-x-hidden bg-[#e9e9e9] px-4 pt-10 pb-2 text-black sm:px-6 lg:px-8" aria-label="Contact section">
      <div className="container mx-auto flex flex-1 flex-col pt-10">
