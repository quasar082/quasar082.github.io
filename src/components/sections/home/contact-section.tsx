...
export const ContactSection = memo(function ContactSection({ contactSocials }: ContactSectionProps) {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative z-20 box-border flex h-full min-h-0 flex-col overflow-hidden bg-[#e9e9e9] px-4 pt-10 pb-2 text-black sm:px-6 lg:px-8" aria-label="Contact section">
